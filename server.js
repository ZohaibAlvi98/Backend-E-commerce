...
app.use(function(req, res, next) {
  ...
  res.setHeader('Access-Control-Allow-Headers', "access-control-allow-headers,access-control-allow-origin,content-type,Authorization_Token,Authorization_Br_Token,Service_ID");
